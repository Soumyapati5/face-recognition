        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    if imgStudent.size != 0:  # Ensure imgStudent is not empty
                        # Resize imgStudent to fit the target area (216x216)
                        imgStudentResized = cv2.resize(imgStudent, (216, 216))
                        
                        # Place the resized student image into the background
                        imgBackground[175:175+216, 909:909+216] = imgStudentResized
                    else:
                        print("No student image found!")
